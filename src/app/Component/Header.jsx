        ...
        <header className="bg-white">
            <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <Link href={'/cart'} className="text-sm font-semibold mx-2 leading-6 text-gray-900">
                        Cart ({getcartdata.length})
                    </Link>
                    <Link href={'/login'} className="text-sm font-semibold mx-2 leading-6 text-gray-900">
                        Login
                    </Link>
                    <Link href={'/signup'} className="text-sm font-semibold leading-6 mx-2 text-gray-900">
