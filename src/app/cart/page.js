...
export default function Page() {
    ...
    const placeorder = () => {
        ...
        axios.post(
            "http://localhost:1000/api/frontend/orders/place-order",
            {
                user_id: userId,
    ...
    const openPaymentPopUp = (order_id, razorpayOrder) => {
        const options = {
            ...
            handler: function (response) {
                ...
                alert('success')
                axios.post("http://localhost:1000/api/frontend/orders/confirm-order",
        ...
        rzp1.on("payment.failed", function (response) {
            ...
            // axios.post("http://localhost:1000/api/frontend/orders/razorpay-transaction-handle",
            ...
            <div class="container mx-auto mt-10">
                <div class="flex shadow-md my-10">
                    <div class="w-3/4 bg-white px-10 py-10">
                                ...
                                <div key={index} class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" >
                                    <div class="flex w-2/5">
                                        ...
                                        <div class="flex flex-col justify-between ml-4 flex-grow">
                                            ...
                                            <a href="#" onClick={() => dispatch(removecart(value.id))} class="font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer">Remove</a>
                                        </div>
                                    </div>
                        ...
                        <a onClick={() => dispatch(emptycart())} class="cursor-pointer flex font-semibold text-indigo-600 text-sm mt-10">
